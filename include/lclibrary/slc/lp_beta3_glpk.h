 ...
 * The file contains SLC beta3 solver using GLPK
 *
 * TODO:
 *
...
#ifndef LCLIBRARY_SLC_LP_BETA3_GLPK_H_
#define LCLIBRARY_SLC_LP_BETA3_GLPK_H_
...
namespace lclibrary {
	...
	class SLC_LP_beta3_glpk:public SLC_LP {
		size_t n_, m_, m_nr_;
		...
		public:
		SLC_LP_beta3_glpk(const std::shared_ptr <const Graph> );
		~SLC_LP_beta3_glpk() {
			glp_delete_prob(lp_);
			delete [] ia_;
			delete [] ja_;
...
#endif /* LCLIBRARY_SLC_LP_BETA3_GLPK_H_ */
